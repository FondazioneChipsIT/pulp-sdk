...
export PATH="$PULP_SDK_HOME/bin":$PATH
...
export PATH=$PULP_SDK_HOME/../gvsoc/gapy/bin:$PATH

# GVSOC
# export GVSOC_MODULES="${GAP_SDK_HOME}/tools/gvsoc/core/models;${GAP_SDK_HOME}/tools/gvsoc/pulp"
export GVSOC_MODULES="${GAP_SDK_HOME}/../gvsoc/core/models;${GAP_SDK_HOME}/../gvsoc/pulp"
